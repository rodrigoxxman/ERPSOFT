...
<div class="form-group {{ $errors->has('FechaOp') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" style="width: 20%;" name="FechaOp" type="text" id="FechaOp" value="{{ old('FechaOp', optional($oportunidad)->FechaOp) }}" required="true" placeholder="Ingresa la fecha de la oportunidad aquí...">
